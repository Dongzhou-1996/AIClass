...
mode = 'train'
model_name = 'ResNet18'  # ResNet18, ResNet34, ResNet52
...
if model_name == 'ResNet18':
    ...
    model = resnet52(num_classes=100)
else:
    raise ValueError('Unsupported model type! only ResNet18, ResNet34 and ResNet52 are supported!')
